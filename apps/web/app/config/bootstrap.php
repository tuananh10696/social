...
define('BACKUP_DB_DAY', 10); // 過去10日間分のバックアップを保存します。※crontabの設定が必須となります
define('BACKUP_DB_MONTH_KEEP', 'off'); // on:毎月１つのDBバックアップファイルを残す。※BACKUP_DB_DAYの値は１以上にしてください

define('NO_IMAGE_PC', '/common/images/pc_no_image.png');
define('NO_IMAGE_SP', '/common/images/sp_no_image.png');

define('COPYRIGHT', 'Copyright &copy; CATERS Inc. all rights reserved.');
/*
 * Bootstrap CakePHP.
 *

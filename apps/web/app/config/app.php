...
return [
    ...
    'convert_path' => env('CONVERT_PATH', '/usr/local/bin/convert'),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'e389008c90f8ce9574404e77d4a22d808deb7b1189343675f6ea7c1c3ace9fa3'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'additionalParameters' => '-f ' . env('EMAIL_TRANSPORT_DEFAULT', 'test@caters.co.jp'),
        ],
    ],

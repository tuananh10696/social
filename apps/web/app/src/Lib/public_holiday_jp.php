...
class public_holiday
{
    ...
    function get_rc()
    {
        return array_merge_recursive($this->rc, array('w' => $this->w));
    }
...
class public_holiday_jp extends public_holiday
{
    ...
    var $tbl_SpecificDay = array(
        ...
        array(2, 23, 20200101, 99999999, '天皇誕生日'),        // 平成元年法律４号
        ...
        array(8, 11, 20160811, 99999999, '山の日'),                // 平成２６年法律４３号
        ...
        array(12, 23, 19890217, 20199999, '天皇誕生日'),

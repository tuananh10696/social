  ...
  <div class="table__column">
    ...
    <div class="block_content">
      <?= $this->Form->input("info_contents.{$rownum}.title", [
        'type' => 'text',
        'style' => 'width: 100%;',
        'class' => 'form-control font_target h3_title',
        'maxlength' => 100, 'readonly' => $fixed_readonly,
        'placeholder' => \App\Model\Entity\Info::BLOCK_TYPE_LIST[\App\Model\Entity\Info::BLOCK_TYPE_TITLE_H4] . 'を入力してください'
      ]); ?>
    </div>
  </div>

  <div class="table__column table__column-sub">
    <span style="font-size:0.9rem;"><?= (h($rownum) + 1); ?>.<?= \App\Model\Entity\Info::BLOCK_TYPE_LIST[\App\Model\Entity\Info::BLOCK_TYPE_TITLE_H4]; ?></span>

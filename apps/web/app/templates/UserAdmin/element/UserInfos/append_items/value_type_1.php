...
?>
        ...
        <br><span class="attention">※半角数字で入力してください</span>
        <?= empty($length)?'':'<br><span class="attention">※'.h($length).'文字以内で入力してください</span>';?>
        <?= $this->Html->view($append['attention'], ['before' => '<br><span class="attention">', 'after' => '</span>']); ?>

...
<div class="table__row first-dir item_block" id="block_no_<?= h($rownum); ?>" data-sub-block-move="1">
  <div class="table__column">
    ...
    <div class="block_content">
      <?= $this->Form->input("info_contents.{$rownum}.title", [
        'type' => 'text',
        'style' => 'width: 100%;',
        'class' => 'form-control font_target h1_title',
        'maxlength' => 100,
        'readonly' => $fixed_readonly,
        'placeholder' => \App\Model\Entity\Info::BLOCK_TYPE_LIST[\App\Model\Entity\Info::BLOCK_TYPE_TITLE_H1] . 'を入力してください'
      ]); ?>
    </div>
  ...
  <div class="table__column table__column-sub">
    <div class="table__row">
      <span style="font-size:0.9rem;"><?= (h($rownum) + 1); ?>.<?= \App\Model\Entity\Info::BLOCK_TYPE_LIST[\App\Model\Entity\Info::BLOCK_TYPE_TITLE_H1]; ?></span>
    </div>

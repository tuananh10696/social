    ...
    <div class="table_area">
      <table>
        <tr>
          ...
          <th style="text-align:left;width: 250px;">名前</th>
          <th style="text-align:left; width: 250px;">メールアドレス/ログインアカウント</th>
          <th style="text-align:left;">サイト権限</th>
          <th style="text-align:left; width: 100px;">ユーザー権限</th>
        </tr>
